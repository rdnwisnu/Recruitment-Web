    ...
    <section class="content">
      <div class="row">
        <div class="col-md-12">
          <div class="card card-outline card-info">
            ...
            <div class="card-body pad">
              <div class="mb-3">
              <form action="<?php echo site_url("job/create");?>" method="post">
            <div class="form-group">
        <div class="row">
        <div class="col-md-6">
        <label>Title</label>
              <input type="text" name="title" class="form-control" placeholder="Enter Name Job's">
        </div>
        ...
        <label>Date From</label>
                 <input type="date" name="date_from" class="form-control" placeholder="Enter Date From Job's">
        </div>
        <div class="col-md-6">
        <label>Date Thru</label>
              <input type="date" name="date_thru" class="form-control" placeholder="Enter Date Thru Job's">
        </div>
        </div>
        <br>
        <div class="row">
        ...
        <br>
              ...
              <table>
              <td>
                      <button type="submit" name="btnPost" class="btn btn-block btn-primary" value='1'>Post</button>
              </td>
              <td>
