...
if ($this->session->flashdata('alert-personal') == 'Error_personal'){
  ...
  }else if($this->session->flashdata('alert-personal') == 'Success_personal'){
            $alert = 'success';
...
<head>
    ...
    <link href="../../assets/font/font-proxima.css" rel="stylesheet">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12 form-wizard">
                    ...
                    <!-- Form Wizard -->
                    <form role="form" action="<?php echo site_url('users/insert_personal'); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                        <!-- Form progress -->
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="datepicker date input-group tanggallahir">
                                                <input type="text" name="tanggal_lahir" id="tanggal_lahir" class="form-control" id="reservationDate">
                            ...
                            <div class="d-inline-block mt-2 w-100">
                                <div class="container">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-2">
                                            <input type="text" id="kota_kabupaten" name="kota_kabupaten" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <p class="text-uppercase font-weight-bold text-danger" style="font-size: 1.3rem;">Keluarga yang bisa di hubungi</p>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-3">
                                            <select class="custom-select" id="hubungan_keluarga" name="hubungan_keluarga">
                                                <option value="">-- Pilih --</option>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-4 font-weight-bold">Jenis Kelamin</label>
                                        <div class="col-md-3">
                                            <select class="custom-select" id="jenis_kelamin_keluarga" name="jenis_kelamin_keluarga">
                                                <option value="">-- Pilih --</option>
                                                <option value="1">Lai-laki</option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="alamat_keluarga" id="alamat_keluarga" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-4 font-weight-bold">No Telp</label>
                                        <div class="col-md-3">
                                            <input type="text" name="no_telp_keluarga" id="no_telp_keluarga" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-inline-block mt-2 w-100">
                                <div class="container">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="institusi_pendidikan" id="institusi_pendidikan" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-4 font-weight-bold">Jenjang Pendidikan</label>
                                        <div class="col-md-2">
                                            <select class="custom-select" id="jenjang_pendidikan" name="jenjang_pendidikan">
                                                    <option value="">-- Pilih --</option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="datepicker date input-group tahunmasuk">
                                                <input type="text" id="tahun_masuk" name="tahun_masuk" class="form-control" id="reservationDate">
                                                <div class="input-group-append"><span class="input-group-text"><i class="fas fa-calendar-alt"></i></span></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="datepicker date input-group tahunlulus">
                                                <input type="text" id="tahun_lulus" name="tahun_lulus" class="form-control" id="reservationDate">
                                                <div class="input-group-append"><span class="input-group-text"><i class="fas fa-calendar-alt"></i></span></div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="d-inline-block mt-2 w-100">
                                <div class="container">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="datepicker date input-group masukperusahaan">
                                                <input type="text" name="masuk_perusahaan" id="masuk_perusahaan" class="form-control" id="reservationDate">
                                                <div class="input-group-append"><span class="input-group-text"><i class="fas fa-calendar-alt"></i></span></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="datepicker date input-group berakhirperusahaan">
                                                <input type="text" name="berakhir_perusahaan" id="berakhir_perusahaan" class="form-control" id="reservationDate">
                                                <div class="input-group-append"><span class="input-group-text"><i class="fas fa-calendar-alt"></i></span></div>
                                            </div>
                                        </div>
                                    </div>

                                    <p class="text-uppercase font-weight-bold" style="font-size: 1.3rem;">Minat Kerja</p>
                                    <div class="form-group row">
                                        <label class="col-4 font-weight-bold">Bersedia Berpergian</label>
                                        <div class="col-2">
                                            <select class="custom-select" id="bersedia_berpergian" name="bersedia_berpergian">
                                                    <option value="">-- Pilih --</option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-3">
                                            <input type="number" name="gaji_diharapkan" id="gaji_diharapkan" class="form-control"><small>IDR</small>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-4 font-weight-bold">Tanggal Dapat / Siap Mulai Bekerja</label>
                                        <div class="col-md-2">
                                            <div class="datepicker date input-group tanggalsiapbekerja">
                                                <input type="text" class="form-control" id="tanggal_siap_bekerja" name="tanggal_siap_bekerja">
                                                <div class="input-group-append"><span class="input-group-text"><i class="fas fa-calendar-alt"></i></span></div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <fieldset>
                            ...
                            <div class="d-inline-block mt-2 w-100">
                                <div class="container">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="file" id="upload_transkip" name="upload_transkip" accept="image/*">
                                            <div class="taranskip-info">
                                        </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="file" id="upload_kartu_keluarga" name="upload_kartu_keluarga" accept="image/*">
                                            <div class="kk-info">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="file" id="upload_akter_lahir" name="upload_akte_lahir" accept="image/*">
                                            <div class="akte-info">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="form-wizard-buttons">
                                <button type="button" class="btn btn-previous">Previous</button>
                                <button type="submit" name="btnPersonal" id="btnPersonal" value="1" class="btn btn-next">Save</button>
                            </div>
                        </fieldset>
     ...
     $(document).ready( function () {
        get_personal();
         function get_personal(){
             $.ajax({
                 type  : 'ajax',
                 url   : "<?php echo site_url('job/show_personal_admin/'.$id)?>",
                 async : false,
                 dataType : 'json',
                 success : function(data){
                     ...
                     for(i=0; i<data.length; i++){
                        if (data[i].foto_diri !== null){
                            $('.foto-diri').append("");
                            $('.foto-diri').append("<a type='button' href='<?php echo base_url('assets/images/');?>"+data[i].foto_diri+"' value='view_image' target='_blank' class='button'>view photo</a>");
                        }else{
                            $('.foto-diri').append("");
                        }
                        if (data[i].upload_ktp !== null){
                            $('.ktp-info').append("");
                            $('.ktp-info').append("<a type='button' href='<?php echo base_url('assets/images/');?>"+data[i].upload_ktp+"' value='view_image' target='_blank' class='button'>view ktp</a>");
                        }else{
                            $('.ktp-info').append("");
                        }
                        if (data[i].upload_cv !== null){
                            $('.cv-info').append("");
                            $('.cv-info').append("<a type='button' href='<?php echo base_url('assets/images/');?>"+data[i].upload_cv+"' value='view_image' target='_blank' class='button'>view cv</a>");
                        }else{
                            $('.cv-info').append("");
                        }
                        if (data[i].upload_ijazah !== null){
                            $('.ijazah-info').append("");
                            $('.ijazah-info').append("<a type='button' href='<?php echo base_url('assets/images/');?>"+data[i].upload_ijazah+"' value='view_image' target='_blank' class='button'>view ijazah</a>");
                        }else{
                            $('.ijazah-info').append("");
                        }
                        if (data[i].upload_transkip !== null){
                            $('.transkip-info').append("");
                            $('.transkip-info').append("<a type='button' href='<?php echo base_url('assets/images/');?>"+data[i].upload_transkip+"' value='view_image' target='_blank' class='button'>view transkip</a>");
                        }else{
                            $('.transkip-info').append("");
                        }
                        if (data[i].upload_akte_lahir !== null){
                            $('.akte-info').append("");
                            $('.akte-info').append("<a type='button' href='<?php echo base_url('assets/images/');?>"+data[i].upload_akte_lahir+"' value='view_image' target='_blank' class='button'>view akte</a>");
                        }else{
                            $('.akte-info').append("");
                        }
                        if (data[i].upload_kartu_keluarga !== null){
                            $('.kk-info').append("");
                            $('.kk-info').append("<a type='button' href='<?php echo base_url('assets/images/');?>"+data[i].upload_kartu_keluarga+"' value='view_image' target='_blank' class='button'>view akte</a>");
                        }else{
                            $('.kk-info').append("");
                        }
                        ...
                        $('.berakhirperusahaan').datepicker('update', data[i].berakhir_perusahaan);
                        $("#bersedia_berpergian").val(data[i].bersedia_berpergian);
                        $("#gaji_diharapkan").val(data[i].gaji_diharapkan);
                        $('.tanggalsiapbekerja').datepicker('update', data[i].tanggal_siap_bekerja);
                     }
                 }
